...
sap.ui.define([], function () {
   ...
   */
  function invalidateCSRFToken(endpoint) {
   ...
   */
  async function fetchCSRFToken(endpoint) {
    /**
   ...
   */
  function hasCSRFTokenError(response) {
    return response.headers.get("X-CSRF-Token") === "Required";
  }
  var __exports = {
    __esModule: true
  };
  __exports.invalidateCSRFToken = invalidateCSRFToken;
  __exports.fetchCSRFToken = fetchCSRFToken;
  __exports.hasCSRFTokenError = hasCSRFTokenError;
  return __exports;
});
//# sourceMappingURL=csrfToken-dbg.js.map
